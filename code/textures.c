...
void init_textures(){
    ...
    glGenTextures(15, texture_n);

    // Kreira se tekstura za loptu
    image_read(image, BALL_FILE);
    ...
    // Kreira se tekstura za teren
    image_read(image, PITCH_FILE);
    ...
    // Desna strana scene
    image_read(image, RIGHT_SIDE_FILE);
    ...
    image_read(image, FRONT_SIDE_FILE);
    ...
    // Leva strana scene
    image_read(image, LEFT_SIDE_FILE);
    ...
    // Zadnja strana scene
    image_read(image, BACK_SIDE_FILE);
    ...
    // Donja strana scene
    image_read(image, DOWN_SIDE_FILE);
    ...
    // Kreira se tekstura za zemlju
    image_read(image, SOIL_FILE);
    ...
    // Kreira se tekstura za ogradu
    image_read(image, FANCE_FILE);
    ...
    // Kreira se tekstura za reklame
    image_read(image, ADD_FILE);
    ...
    // Tekstura za pocetak igre
    image_read(image, START_GAME_FILE);
    ...
    // Tekstura za goaal igre
    image_read(image, GOOAL_FILE);
    ...
    // Tekstura za kraj igre igre
    image_read(image, GAME_OVER_FILE);
